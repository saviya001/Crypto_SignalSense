...
with st.sidebar:
    ...
    st.markdown("---")
    # Edit 3.png: Sidebar caption set to Crypto SignalSense
...
# Edit 4.png: Academic & Educational Disclaimer Banner text update
st.warning("⚠️ **Academic & Educational Disclaimer:** Signals, Entry, TP, and SL estimates generated by this AI system are educational technical calculations derived from Support/Resistance levels and ATR volatility.")
...
# Edit 1.png: Footer caption set to Crypto SignalSense
st.markdown("---")
st.caption("⚡ Crypto SignalSense")
